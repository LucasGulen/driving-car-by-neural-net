...
class Circle {
    ...
    */
    ...
    getDistances() {
        ...
        distance = this.getDistantPointByAngle(-2);  
        const distLeft = Math.trunc(dist(this.pos.x, this.pos.y, distance.x, distance.y));

        distance = this.getDistantPointByAngle(-1);    
        ...
        distance = this.getDistantPointByAngle(0);    
    ...
    getDistantPointByAngle(angle) {
        let distance = createVector(this.pos.x, this.pos.y);
        distance.add(p5.Vector.mult(this.direction, 15));
